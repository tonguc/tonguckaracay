...
- **Portfolyo:** `/vaka-calismalari` altında Behance'teki tüm projeler (`lib/portfolio.ts`, kapaklar `public/portfolio/<id>.webp`), tür filtreli 2/3/4 sütun grid (`components/cases/PortfolioGrid.tsx`).
