...
const copy = {
  tr: {
    ...
    titlePre: "Ücretsiz Ön Analiz Talebi",
    introPre: "Site adresinizi ve hedefinizi yazmanız yeterli. Birkaç iş günü içinde en büyük 3 fırsatı yazılı olarak iletiyorum.",
  ...
  en: {
    ...
    titlePre: "Request a Free Pre-Audit",
    introPre: "Just share your site address and goal. Within a few business days I'll send you the 3 biggest opportunities in writing.",
