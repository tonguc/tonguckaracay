    ...
    <section className="pt-28 pb-12 md:pt-40 md:pb-28 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Social Links */}
          <div className="flex flex-wrap justify-center gap-5 md:gap-6 mb-8 md:mb-12">
            <a
              href="https://www.linkedin.com/in/tongu%C3%A7-kara%C3%A7ay-36311040/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="flex items-center gap-1.5 text-sm text-primary-400 hover:text-accent-400 transition-colors"
            >
