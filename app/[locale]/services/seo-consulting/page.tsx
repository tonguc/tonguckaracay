...
export const metadata: Metadata = {
  title: "SEO Consulting | Organic Traffic Growth | Tonguç Karaçay",
  description: "Technical SEO, content strategy, and link building with 25+ years of experience. Rank higher on Google.",
};

const services = [
  { icon: Search, title: "Technical SEO", description: "Site speed, mobile compatibility, indexing and crawling optimization." },
  { icon: FileText, title: "Content Strategy", description: "Keyword research and SEO-friendly content planning." },
  { icon: Link2, title: "Link Building", description: "Quality backlink strategies to increase domain authority." },
  { icon: Globe, title: "International SEO", description: "Global SEO strategies for multiple languages and regions." },
  { icon: BarChart3, title: "SEO Analytics", description: "Performance tracking, reporting, and continuous optimization." },
  { icon: Zap, title: "Core Web Vitals", description: "Optimizing Google's page experience metrics." }
];
    ...
    <main className="pt-20">
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-bold text-white mb-6">
            <span className="text-gradient">SEO Consulting</span>
          </h1>
          <p className="text-xl text-primary-300 mb-8 max-w-2xl">
            Rank higher on Google. Increase your organic traffic with technical SEO, content strategy, and link building.
          </p>
      ...
      <section className="py-20 bg-gradient-to-br from-accent-500/10 to-indigo-500/10">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-display font-bold text-white mb-6">Let's Build Your SEO Strategy</h2>
