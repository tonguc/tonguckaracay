...
faq:
  - question: "AI agent müşteri hizmetlerinde ne işe yarar?"
    answer: "AI agent, doğal dil işleme (NLP) teknolojisiyle müşteri sorularını otomatik yanıtlar, talepleri kategorize eder ve karmaşık durumları insan temsilcilere yönlendirir. Gartner verilerine göre, agentic AI sistemleri 2029'a kadar müşteri hizmetleri sorunlarının %80'ini insan müdahalesi olmadan çözebilecek. Geleneksel chatbotlardan farklı olarak AI agentlar bağlamı anlayabilir, önceki etkileşimleri hatırlayabilir ve kişiselleştirilmiş çözümler sunabilir."
  - question: "AI agent ile chatbot arasındaki fark nedir?"
    answer: "Geleneksel chatbotlar önceden tanımlanmış kurallara göre çalışır ve sınırlı senaryolarda etkilidir. AI agentları ise makine öğrenmesi ve NLP kullanarak bağlamı anlayabilir, plan yapabilir ve inisiyatif alabilir. Bir chatbot 'Sipariş nerede?' sorusuna standart cevap verir, AI agent ise müşterinin geçmiş sipariş geçmişini analiz ederek kişiselleştirilmiş çözüm sunar. TÜİK verilerine göre, Türkiye'deki işletmelerin %46,5'i yapay zekayı pazarlama ve satış için kullanıyor."
  - question: "Müşteri hizmetleri otomasyonu kaç günde kurulur?"
    answer: "Temel bir chatbot kurulumu 3-5 iş günü, orta seviye AI agent sistemi 2-3 hafta, kapsamlı entegrasyonlar ise 1-2 ay sürer. Kurulum süresi işletmenizin mevcut sistemlerine, müşteri soru hacmine ve özelleştirme ihtiyacına göre değişir. Küçük işletmeler için hazır SaaS çözümleri (Intercom, Zendesk) birkaç saat içinde aktif hale getirilebilir. Önemli olan acele etmeden doğru verilendirme ve test sürecini tamamlamaktır."
  - question: "AI agent kurulumu ne kadar maliyet gerektirir?"
    answer: "Küçük işletmeler için aylık $50-200 arası SaaS chatbot çözümleri mevcuttur (Tidio, ManyChat). Orta ölçekli AI agent platformları aylık $300-1000, kurumsal çözümler ise $2000+ bütçe gerektirir. Türkiye'de yerli alternatifler (Alotech, Sestek) kullanılarak KVKK uyumlu sistemler kurulabilir. Gartner tahminlerine göre conversational AI, 2026'da çağrı merkezi maliyetlerinden 80 milyar dolar tasarruf sağlayacak. İlk yatırım 6-12 ayda kendini amorte eder."
  - question: "KVKK uyumlu AI agent nasıl kurulur?"
    answer: "KVKK uyumu için: 1) Müşteri verilerini Türkiye sunucularında saklayın (AWS İstanbul, Azure Türkiye), 2) Açık rıza metni ile veri toplama iznini alın, 3) Veri işleme sözleşmesi yapın, 4) Kullanıcılara veri silme hakkı tanıyın, 5) Veri aktarım kayıtlarını tutun. Yerli çözümler (Alotech, Sestek) otomatik KVKK uyumu sunar. Kişisel Verileri Koruma Kurumu'nun rehberini takip ederek 6698 sayılı kanuna uygunluk sağlayın."
  - question: "AI agent hangi platformlara entegre edilir?"
    answer: "AI agentlar web sitesi, WhatsApp Business API, Instagram Direct, Facebook Messenger, e-posta ve CRM sistemlerine entegre edilebilir. Popüler entegrasyonlar: Shopify, WooCommerce, HubSpot, Salesforce, Zendesk, Intercom. API üzerinden özel sistemlere bağlantı kurulabilir. Omnichannel yaklaşım için tüm kanalları tek bir AI agent platformunda birleştirin. Müşterilerin %51'i anlık hizmet beklediği için çok kanallı destek kritik önem taşır."
  - question: "AI agent performansı nasıl ölçülür?"
    answer: "Ana metrikler: İlk yanıt süresi (ortalama 30 saniye altı), çözüm oranı (%60-80 hedefi), müşteri memnuniyeti skoru (CSAT 4/5 üzeri), bot-insan yönlendirme oranı (%20 altı), etkileşim başına maliyet. Google Analytics, Mixpanel veya platform kendi dashboard'unu kullanarak haftalık raporlama yapın. A/B test ile farklı yanıt senaryolarını karşılaştırın. Sürekli iyileştirme için aylık performans incelemesi yapın ve NLP modelini güncelleyin."
  - question: "AI agent ne tür soruları otomatik yanıtlayabilir?"
    answer: "AI agentlar şu tür soruları otomatik yanıtlar: Sipariş takibi ve kargo durumu, hesap bilgileri ve şifre sıfırlama, ürün özellikleri ve fiyat bilgileri, iade/değişim prosedürleri, sıkça sorulan sorular (SSS), randevu planlama. Karmaşık şikayetler, özel indirim talepleri ve duygusal olarak yüklü durumlar insan temsilciye yönlendirilir. Makine öğrenmesi ile zaman içinde yanıt kapasitesi genişler. İlk 3 ayda %60, 6 ayda %80 otomatik çözüm oranına ulaşılabilir."
---
...
**SSS Dokümantasyonu:**
En az 50-100 soru-cevap çiftini hazırlayın. Her cevap 40-60 kelime, açık ve net olmalı.
...
E-ticaret siteniz varsa ürün verilerini (fiyat, stok durumu, özellikler) API üzerinden AI agent'a bağlayın.
...
**1. Basit Bilgi Talebi:**
Müşteri: "Açık adresiniz nedir?"
Bot: "İstanbul Kadıköy Moda Caddesi No:45 adresindeyiz. Çalışma saatlerimiz hafta içi 09:00-18:00, Cumartesi 10:00-16:00."

**2. İşlem Gerektiren Talep:**
Müşteri: "Ürünümü iade etmek istiyorum."
Bot: "İade talebinizi hemen oluşturalım. Sipariş numaranızı paylaşır mısınız?"
[Müşteri numara girer]
Bot: "#12345 numaralı siparişinizi görüyorum. İade nedeni: [Seçenekler sunulur]"

**3. Karmaşık/Duygusal Durum:**
Müşteri: "3 gün oldu, paketim hala gelmedi, çok kızgınım!"
Bot: "Üzgünüm, memnuniyetsizliğinizi anlıyorum. Durumunuzu öncelikli olarak ele almak için müşteri temsilcimiz Ahmet Bey'e bağlıyorum. Ortalama bekleme süresi 2 dakika."
...
**Test Senaryoları:**
En az 20 farklı müşteri senaryosunu test edin:
...
**Soft Launch:**
İlk 2 hafta trafiğin %20-30'unu AI agent'a yönlendirin. Geri kalan talepleri insan temsilciler yanıtlasın.
...
**Sürekli İyileştirme:**
Aylık performans incelemesi yapın:
...
Chatbot ilk etkileşimde şu metni göstermeli:
"Merhaba! Size daha iyi hizmet verebilmek için sohbet geçmişinizi ve iletişim bilgilerinizi işleyeceğiz. Kişisel verilerinizin işlenmesine dair [Aydınlatma Metni] bağlantısını inceleyebilirsiniz. Devam ederek kabul etmiş sayılırsınız."
...
[Kişisel Verileri Koruma Kurumu](https://www.kvkk.gov.tr/) rehberlerini düzenli takip edin.
...
**AI Agent Yanıtı:**
1. Sipariş numarasını sorar
2. Sistemden kargo bilgisini çeker
3. "12345 numaralı siparişiniz Aras Kargo ile 10 Nisan'da tarafınıza ulaşacak. Kargo takip numarası: 123456789. [Kargo takip linki]" yanıtını verir
4. "Başka bir konuda yardımcı olabilir miyim?" diye sorar
...
**AI Agent Yanıtı:**
1. Müşteri tercihlerini sorar (marka, ekran boyutu, kamera kalitesi)
2. Ürün kataloğundan eşleşen modelleri listeler
3. "Xiaomi Redmi Note 12 (489 TL, 6.67" ekran, 50MP kamera) ve Samsung Galaxy A14 (499 TL, 6.6" ekran, 13MP kamera) modellerini önerebilirim. Detaylı karşılaştırma için [link]" yanıtını verir
...
**AI Agent Yanıtı:**
1. Duygu analizi negatif skoru algılar
2. "Çok üzgünüm, yaşadığınız sorunu en kısa sürede çözmek istiyoruz. Müşteri temsilcimiz Ayşe Hanım'a bağlıyorum, ortalama bekleme süresi 1 dakika" der
3. Temsilciye müşteri bilgilerini ve sohbet geçmişini aktarır
...
Genç hedef kitle için: "Merhaba! 👋 Nasıl yardımcı olabilirim?"
Kurumsal müşteriler için: "İyi günler. Size nasıl destek olabilirim?"
...
Web sitesinde 30 saniye kalan ziyaretçiye: "Merhaba! Ürün seçiminde yardımcı olabilir miyim?"
Sepeti terk eden müşteriye WhatsApp: "Sepetinizdeki ürünler hala sizi bekliyor. %10 indirim kodu: GERIDON"
